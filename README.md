...
Результат: 
Решение использует функции (CTE) для поэтапной фильтрации и агрегации, что повышает читаемость и потенциально оптимизирует выполнение запроса за счет предварительной обработки данных и вычесляет нужные метрики.
